...
Namespace MultiRangeTrackBarControlExample
    ...
    Public Class RepositoryItemMultiTrackBar
        ...
        Public Shared Sub RegisterCustomTrackBar()
            ...
            EditorRegistrationInfo.[Default].Editors.Add(New EditorClassInfo(CustomEditName, GetType(MultiRangeTrackBar), GetType(RepositoryItemMultiTrackBar), GetType(MultiTrackBarViewInfo), New TrackBarPainter(), True, img, GetType(TrackBarAccessible)))
        End Sub
