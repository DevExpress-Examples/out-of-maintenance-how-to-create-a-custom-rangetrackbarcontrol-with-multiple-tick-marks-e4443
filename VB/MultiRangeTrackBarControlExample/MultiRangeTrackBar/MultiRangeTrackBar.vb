...
Namespace MultiRangeTrackBarControlExample
    ...
    Public Class MultiRangeTrackBar
        ...
        Private _ActiveThumbIndex As Integer
        ...
        Protected Overrides Sub OnMouseMove(ByVal e As MouseEventArgs)
            ...
            If ActiveThumbIndex <> -1 Then
                ...
                Dim newValue As Integer = Math.Max(minBound, Math.Min(maxBound, valueFromPoint))
        ...
        Public Property ActiveThumbIndex As Integer = -1
            Get
                Return _ActiveThumbIndex
            End Get

            Protected Set(ByVal value As Integer)
                _ActiveThumbIndex = value
            End Set
        End Property
    End Class
End Namespace
